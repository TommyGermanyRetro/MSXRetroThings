...
routine via `_XIO SET ADDR` on the chosen IM2 channel, and toggles PA0 in the main loop. Reports
which PIO channel fired the interrupt. IO address and IM2 channel (0..7) are both asked for
interactively.

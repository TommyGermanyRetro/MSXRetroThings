...
`XIO SET ADDR` on the chosen IM2 channel, toggles PA0, reports which channel fired. IO address and
IM2 channel are command-line parameters (`/IO:<0..252>` and `/INT:<0..7>`) instead of interactive
prompts.
